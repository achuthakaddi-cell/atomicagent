 ...
 * responses. Internal details are logged but never sent to the client — an
 * error response is a product surface, not a debug dump.
 */
 ...
 * recognise it as an error handler — a framework requirement, not a style
 * choice, which is why `next` is present but unused.
 */
